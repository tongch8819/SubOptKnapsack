...
def modified_greedy_ub1l(model: BaseTask):
    return modified_greedy(model, "ub1l")


def modified_greedy_ub1ml(model: BaseTask):
    return modified_greedy(model, "ub1ml")

def modified_greedy_ub7l(model: BaseTask):
    return modified_greedy(model, "ub7l")

def modified_greedy_ub7ml(model: BaseTask):
    return modified_greedy(model, "ub7ml")
