...
def greedy_max_nis_ept(model: BaseTask, upb: str = None):
    """
    # algorithm
    # implement upper bound mentioned in revisiting original paper
    """
...
def greedy_max_nis_sol(model: BaseTask, upb: str = None):
    """
    # algorithm
    # implement upper bound mentioned in revisiting original paper
    """
...
def greedy_max_nis_ept_ub1(model):
    return greedy_max_nis_ept(model, "ub1")
def greedy_max_nis_ept_ub1ma(model):
    return greedy_max_nis_ept(model, "ub1ma")
def greedy_max_nis_ept_ub7(model):
    return greedy_max_nis_ept(model, "ub7")
def greedy_max_nis_ept_ub7ma(model):
    return greedy_max_nis_ept(model, "ub7ma")
def greedy_max_nis_sol_ub1(model):
    return greedy_max_nis_sol(model, "ub1")
def greedy_max_nis_sol_ub1ma(model):
    return greedy_max_nis_sol(model, "ub1ma")
def greedy_max_nis_sol_ub7(model):
    return greedy_max_nis_sol(model, "ub7")
...
def greedy_max_ub1ma(model):
    return greedy_max(model, "ub1ma")
...
def greedy_max_ub7ma(model):
    return greedy_max(model, "ub7ma")
